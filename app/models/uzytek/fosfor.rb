...
class Uzytek::Fosfor
  ...
  #    wg. T. Jadczyszyn
  def zapas
    if resztki_pozniwne.nil?
      nil
    else
      resztki_pozniwne * @u.roslinaprzedplon.wsp_fosfor_i_rok
    end
  end
  ...
  def zapasy_nawoz_i
    ...
    @u.nawozywykorzystane.each do |nawoz|
      ...
      fosfor += nawoz.animal.fosfor * wsp * nawoz.animal.systemutrzymania.nazwautrzymania.wspwykorzystania.wsp_fosfor_i_rok
    end
    fosfor
  end
  ...
  def wynik
    if zapasy_nawoz_ii.nil? or potrzeby_nawozowe.nil?
      ...
      zapasy_nawoz_i + zapasy_nawoz_ii + resztki - potrzeby_nawozowe
    end
  end
